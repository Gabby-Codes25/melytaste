...
export default function Home() {
  return (
    <div>
      <div className="bg-banner bg-cover bg-center opacity-50 h-screen flex items-center justify-center">
        <div className="text-center text-white px-4">
          <h1 className="text-4xl md:text-6xl font-bold">Welcome to MelyTaste</h1>
          <p className="mt-4 text-lg md:text-xl">Your go-to place for the best tastes and recipes.</p>
